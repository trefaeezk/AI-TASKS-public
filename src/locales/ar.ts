...
const ar = {
  ...
  roleDescriptions: {
    ...
    org_admin: "أدمن المؤسسة - صلاحيات إدارية واسعة داخل المؤسسة",
    org_supervisor: "مشرف - يشرف على الفرق والمهام ويدير العمليات",
    org_engineer: "مهندس - يصمم ويخطط المشاريع والحلول التقنية",
    org_technician: "فني - ينفذ المهام التقنية والصيانة",
    org_assistant: "مساعد فني - يساعد في تنفيذ المهام البسيطة"
  },
