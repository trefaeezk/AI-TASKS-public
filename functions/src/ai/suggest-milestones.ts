...
// نوع المدخلات
type SuggestMilestonesInput = z.infer<typeof SuggestMilestonesInputSchema>;

// نوع المخرجات
type SuggestMilestonesOutput = z.infer<typeof SuggestMilestonesOutputSchema>;
...
`;
    ...
    console.log(`[AI] Successfully generated ${result.suggestedMilestones.length} milestones`);
    return result;
